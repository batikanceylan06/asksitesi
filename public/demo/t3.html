...
<head>
  ...
  <title>Demo t3 — askimiz.com</title>
  <link rel="stylesheet" href="/assets/css/base.css"/>
  <link rel="stylesheet" href="/assets/css/template.css"/>
  <link rel="stylesheet" href="/assets/css/skin-standard.css"/>
...
<body>
  ...
  <script type="module">
    ...
    const site = {
      ...
      photos: Array.from({length: 12}).map((_,i)=>`https://picsum.photos/seed/askimiz-t3-${i}/900/900`)
    };
    document.getElementById('root').innerHTML = renderTemplate('t3', site);
